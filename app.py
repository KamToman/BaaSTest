...
def get_db_connection():
    connection_string = "Driver={ODBC Driver 17 for SQL Server};Server=tcp:mydbserver-baas.database.windows.net,1433;Database=MyBaaSDb;Uid=baas;Pwd=!Haslo123123;"
